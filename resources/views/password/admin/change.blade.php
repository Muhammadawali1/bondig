    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex items-center mb-4">
                ...
                <h1 class="text-2xl font-bold text-gray-800">Ubah Password Saya</h1>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-800">
                            Sebagai administrator, Anda dapat mengubah password langsung tanpa persetujuan.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('password.store-direct-change') }}" method="POST">
                @csrf
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Masukkan password Anda saat ini untuk konfirmasi
                        </p>
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-green-800">
                                    <strong>Info:</strong> Password Anda akan langsung berubah setelah submit.
                                    Tidak perlu persetujuan dari administrator lain.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button type="submit" 
                                class="bg-green-600 text-white px-6 py-2 rounded-md hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            Ubah Password
                        </button>
                    </div>
                </div>
