...
@section('title', 'Tambah Divisi - Administrator')
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Tambah Divisi</h1>
                            <p class="mt-2 text-gray-600">Tambah divisi baru untuk sistem</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 max-w-2xl">
                    <form method="POST" action="{{ route('administrator.divisions.store') }}">
                        @csrf
