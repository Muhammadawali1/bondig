    ...
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('dashboard') }}"
                class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->is('dashboard') || request()->is('dashboard/*') || request()->is('pegawai/dashboard') || request()->is('atasan/dashboard') || request()->is('gudang/dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50' }} transition-colors">
