    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('atasan.bon.my.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition flex items-center gap-2">
            ...
            <div class="mb-6 flex gap-4 items-center">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('atasan.barang.index') }}?kategori=atk" 
                    ...
                    <a href="{{ route('atasan.barang.index') }}?kategori=art" 
                    ...
                    <a href="{{ route('atasan.barang.index') }}?kategori=tinta" 
                    ...
                    <tbody>
                        @forelse ($barangs as $barang)
                            <tr class="border-t">
                                ...
                                <td class="p-3">
                                    <a href="{{ route('atasan.bon.my.create') }}?barang_id={{ $barang->id }}" 
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="p-4 text-center text-gray-500">
                                    ...
                                    <br>
                                    <a href="{{ route('atasan.barang.index') }}" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">
                                        Lihat semua barang
                                    </a>
                                </td>
                            </tr>
...
function liveSearch() {
    ...
    if (searchValue.length >= 1) {
        ...
        window.location.href = `{{ route('atasan.barang.index') }}?search=${encodeURIComponent(searchValue)}`;
    } else if (searchValue.length === 0) {
        // Redirect ke index tanpa search
        window.location.href = `{{ route('atasan.barang.index') }}`;
    }
}
</script>
@endsection
