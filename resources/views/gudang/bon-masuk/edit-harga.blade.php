...
@section('title', 'Input Harga Satuan - Bon Masuk')
        ...
        <main class="flex-1 p-6">
            <div class="max-w-5xl mx-auto">
                <div class="flex items-center mb-6">
                    ...
                    <h1 class="text-2xl font-bold">Input Harga Satuan</h1>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <p>Silakan input harga satuan untuk setiap barang. Total harga akan dihitung otomatis.</p>
                ...
                <div class="bg-white shadow rounded-lg overflow-hidden mb-6">
                    <div class="px-6 py-4 bg-blue-50 border-b">
                        <h2 class="text-lg font-semibold">Input Harga Satuan</h2>
                    </div>
                    
                    <form method="POST" action="{{ route('gudang.bon-masuk.update-harga', $bonMasuk->id) }}">
                        @csrf
