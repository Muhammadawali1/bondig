...
<?php $__env->startSection('title', 'Dashboard Pegawai - Bonn DIG'); ?>
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div>
                                    ...
                                    <p
                                        ...
                                        Selamat datang, <span
                                            class="font-semibold text-blue-600 group-hover:text-blue-700 transition-colors duration-300"><?php echo e(auth()->user()->name ?? 'Pegawai'); ?></span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    ...
                    <a href="<?php echo e(route('pegawai.barang.index')); ?>" class="group">
                    ...
                    <a href="<?php echo e(route('pegawai.bon.create')); ?>" class="group">
                    ...
                    <a href="<?php echo e(route('pegawai.bon.index')); ?>" class="group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/pegawai/dashboard.blade.php ENDPATH**/ ?>