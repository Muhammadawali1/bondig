        ...
        <main class="flex-1 p-6">
            <div class="max-w-5xl mx-auto">
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <form action="<?php echo e(route('atasan.bon.my.store')); ?>" method="POST" id="bonForm">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="item-row border rounded-lg p-4 bg-gray-50">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div class="flex items-end">
                                            <button type="button" onclick="removeItem(this)" class="bg-red-600 text-white px-3 py-2 rounded hover:bg-red-700 transition text-sm">
                                                Hapus
                                            </button>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/atasan/bon/my-create.blade.php ENDPATH**/ ?>