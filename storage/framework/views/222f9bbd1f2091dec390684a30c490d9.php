        ...
        <main class="flex-1 p-6">
            ...
            <div class="mb-6 flex gap-4 items-center">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('pegawai.barang.index')); ?>?kategori=atk" 
                    ...
                    <a href="<?php echo e(route('pegawai.barang.index')); ?>?kategori=art" 
                    ...
                    <a href="<?php echo e(route('pegawai.barang.index')); ?>?kategori=tinta" 
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-t">
                                ...
                                <td class="p-3">
                                    <a href="<?php echo e(route('pegawai.bon.create')); ?>?barang_id=<?php echo e($barang->id); ?>" 
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="5" class="p-4 text-center text-gray-500">
                                    ...
                                    <br>
                                    <a href="<?php echo e(route('pegawai.barang.index')); ?>" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">
                                        Lihat semua barang
                                    </a>
                                </td>
                            </tr>
...
function liveSearch() {
    ...
    if (searchValue.length >= 1) {
        ...
        window.location.href = `<?php echo e(route('pegawai.barang.index')); ?>?search=${encodeURIComponent(searchValue)}`;
    } else if (searchValue.length === 0) {
        // Redirect ke index tanpa search
        window.location.href = `<?php echo e(route('pegawai.barang.index')); ?>`;
    }
}
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/pegawai/barang/index.blade.php ENDPATH**/ ?>