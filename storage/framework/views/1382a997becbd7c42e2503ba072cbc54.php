    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-3">
                <img src="<?php echo e(asset('logo/logo.png')); ?>" alt="Logo Perusahaan" class="h-8 w-auto">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition
                        ...
                        <?php if(auth()->user()->isAdministrator()): ?>
                            <a href="<?php echo e(route('password.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">⚙️ Ubah Password</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">⚙️ Ubah Password</a>
                        <?php endif; ?>
                    </div>
                </div>
...
<script src="//unpkg.com/alpinejs" defer></script><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/components/navbar.blade.php ENDPATH**/ ?>