<?php $__env->startSection('title', 'Bon Barang'); ?>
                            ...
                            <tbody id="bonTableBody">
                                <?php $__currentLoopData = $bonBarangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-t hover:bg-gray-50 bon-row" data-status="<?php echo e($bon->status); ?>">
                                        ...
                                        <td class="p-3"><?php echo e($bon->pegawai->name); ?></td>
                                        ...
                                        <td class="p-3">
                                            <div class="flex justify-center gap-2">
                                                <a href="<?php echo e(route('atasan.bon.show', $bon->id)); ?>" 
                                                   class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition text-sm">
                                                    Detail
                                                </a>
                                                <?php if($bon->status === 'menunggu_atasan'): ?>
                                                    <form action="<?php echo e(route('atasan.bon.reject', $bon->id)); ?>" method="POST" class="inline" onsubmit="return confirmReject(this, '<?php echo e($bon->kode_bon); ?>')">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/atasan/bon/index.blade.php ENDPATH**/ ?>