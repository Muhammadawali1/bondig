...
<?php $__env->startSection('title', 'Profile Pegawai - Bonn DIG'); ?>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-white shadow-sm rounded-2xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-md">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
                            ...
                            <div class="flex-1 w-full">
                                <div class="text-center md:text-left mb-6">
                                    <h3 class="text-2xl font-bold text-gray-900"><?php echo e(auth()->user()->name); ?></h3>
                                    <p class="text-blue-600 font-medium"><?php echo e(auth()->user()->email); ?></p>
                                </div>

                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                        <p class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">Nomor Induk Pegawai (NIP)</p>
                                        <p class="text-gray-800 font-medium"><?php echo e(auth()->user()->nip ?? '-'); ?></p>
                                    </div>
                                    
                                    <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                        <p class="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">Divisi / Unit Kerja</p>
                                        <p class="text-gray-800 font-medium"><?php echo e(auth()->user()->divisi ?? '-'); ?></p>
                                    </div>
                                </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 flex items-center justify-between text-xs text-gray-400">
                        <span>Terakhir diperbarui: <?php echo e(auth()->user()->updated_at->diffForHumans()); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/profile/index.blade.php ENDPATH**/ ?>