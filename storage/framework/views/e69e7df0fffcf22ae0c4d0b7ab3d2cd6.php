<?php $__env->startSection('title', 'Edit Profile - Bonn DIG'); ?>
                ...
                <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                        <div class="flex-shrink-0">
                            <?php if($user->photo): ?>
                                <img src="<?php echo e(asset('uploads/profile/' . $user->photo)); ?>" 
                                     alt="Profile Photo" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/profile/edit.blade.php ENDPATH**/ ?>