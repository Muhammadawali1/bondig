...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="mb-4">
                <img src="<?php echo e(asset('logo/logo.png')); ?>" alt="Logo" class="w-20 h-20 object-contain mx-auto">
            </div>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                ...
                <div class="mb-6">
                    ...
                    <input id="nip" name="nip" type="text" required
                        ...
                        onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo e(old('email')); ?>">
...
<div>
    ...
    <div class="flex items-center gap-2">
        ...
        <!-- GAMBAR CAPTCHA -->
        <img src="<?php echo e(captcha_src('flat')); ?>" id="captcha-img"
...
function refreshCaptcha(id = 'captcha-img') {
    ...
    captcha.src = "<?php echo e(captcha_src()); ?>" + '?' + Date.now();
}
</script>

</html>

<?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/auth/login.blade.php ENDPATH**/ ?>