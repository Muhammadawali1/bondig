<?php $__env->startSection('title', 'Tambah Bon Masuk - Gudang'); ?>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 p-6">
            <div class="max-w-5xl mx-auto">
                ...
                <form action="<?php echo e(route('gudang.bon-masuk.store')); ?>" method="POST" id="bonMasukForm">
                    <?php echo csrf_field(); ?>
                                        ...
                                        <td class="p-3">
                                            <select name="barang_id[]" class="w-full px-2 py-1 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500" onchange="updateStokInfo(this)" required>
                                                ...
                                                <?php $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($barang->id); ?>" data-stok="<?php echo e($barang->stok); ?>" data-satuan="<?php echo e($barang->satuan); ?>">
                    ...
                    <div class="flex justify-end gap-3">
                        <a href="<?php echo e(route('gudang.bon-masuk.index')); ?>" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition">
                            Batal
                        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\bonn-dig-final-bos\resources\views/gudang/bon-masuk/create.blade.php ENDPATH**/ ?>